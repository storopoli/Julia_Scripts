...
"""
	SIRTD_sim(T::Int64, N::Int64, λₜ::Float64, C::Float64, dᵢ::Int64, dₜ::Int64, β::Float64, ω::Float64, i₀::Int64, seed::Int64)
...
begin
	plot(sol_ode, dpi=300, label=[L"S" L"I" L"R" L"T" L"D"], lw=3, la=0.7, palette=distinguishable_colors(5))
	plot!(sim_data, label=[L"S_{sim}" L"I_{sim}" L"R_{sim}" L"T_{sim}" L"D_{sim}" "tweets"], lw=3, ls=:dot, la=0.7, palette=distinguishable_colors(5))
	xlabel!(L"t")
	ylabel!("N")
end
